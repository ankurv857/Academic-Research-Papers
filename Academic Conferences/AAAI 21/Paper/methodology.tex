...
\hline\hline
Train  		&  Model training &  2,279 &  52 weeks \\ \hline
Validation	  		&  Hyper-Parameter Optimization &  2,359 &  4 weeks \\ \hline
Test1  		&  Stacked Generalization, F\textsubscript{1}-Maximization & 2,394 &  4 weeks\\ \hline
Test2	  		&  Reporting Accuracy Metrics & 2,421 &  4 weeks\\
\hline
\end{tabular}
}
\label{tab:mlmodels}
...
and Figure~\ref{fig:TCN-LSTM}.
  ...
  \begin{figure}[t]
    \centering 
    \caption{Temporal Convolutional Network + Long Short Term Memory (TCN-LSTM)} 
...
Xgboost 		& 6	& Learning rate, Tree Depth, Regularization parameters  & Logloss\\ \hline
RandomForest 		& 6	& Tree Depth, Evaluation Metrics, Regularization parameters &  Entropy, Gini\\
   \hline
\end{tabular}}
\end{table*} 
\end{center}
