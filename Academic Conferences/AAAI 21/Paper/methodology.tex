...
Term Memory (LSTM) and Temporal Convolutional Network (TCN). Architectures of MLP, LSTM, TCN \cite{lea2016temporal} 
...
series is fully connected to the first hidden layer, the temporal information in a time series is lost \cite{fawaz2019deep}.
...
connected network.
\end{itemize}
As described in architecture diagrams Figure \ref{fig:dnndata}, data was classified 
