...
We observe that all the Deep Learning models out perform Machine Learning models including Xgboost and
RandomForest both in terms of Accuracy and Generalization. This insight can be drawn from table 5 which has the average 
of BCELoss across trials. Range of scores across train, val , test1 and test2 states that Deep Learning models are 
showing more stable results in terms of model fit.
...
Table 7 shows the results of the reporting metric.
 \begin{figure}[t]
    \centering 
