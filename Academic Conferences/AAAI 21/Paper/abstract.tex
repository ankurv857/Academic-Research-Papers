...
TCN-LSTM \cite{karim2017lstm} bring over ML models like Xgboost \cite{chen2016xgboost} 
and RandomForest. We present the results of 60 modelling experiments with 
varying Hyper-parameters along with Stacked Generalization ensemble \cite{wolpert1992stacked} and
F\textsubscript{1}-Maximization framework.
