...
\end{itemize}
 ...
 \begin{equation}
    R\textsubscript{v} = \sum_{i=1}^{n}\;\;\;[I\textsubscript{p} - I\textsubscript{p}\times (k \mypm \frac{\eta}{100}\times k)]\times
    \ \mathds{1} \ \textsubscript{c}(f(k) \mypm \epsilon(k,f(k))\times f(k))
    \label{eq:fx}
  \end{equation}

\begin{equation}
    R\textsubscript{r} = \frac{\sum_{i=1}^{n}\; \ \mathds{1} \ \textsubscript{c}(f(k) \mypm \epsilon(k,f(k))\times f(k))}{n}
    \label{eq:fx}
  \end{equation}
...
\begin{equation}
    \max_{\lambda R\textsubscript{v} + \gamma R\textsubscript{r}} \;\;\;\; 2 * \frac{ V\textsubscript{Pr\textsubscript{c}}}{k + b}
    \;\;\;\;,\;\;\;\;  \text{subject to: } \;\;\;\;  Pr\textsubscript{c}  \in \; [0,1]
    \label{eq:constraint}
  \end{equation}
