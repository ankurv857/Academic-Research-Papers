...
optimization function (Equation \ref{eq:optimizer}) to maximize Net Revenue (R\textsubscript{v}),
with Consumer Retention Rate (R\textsubscript{r}) greater than category threshold.
...
i\textsuperscript{th} consumer-item sample (R\textsubscript{r\textsubscript{i}}) can be expressed as Equation \ref{eq:retrate}.
 \begin{equation}
    R\textsubscript{v\textsubscript{i}} = [I\textsubscript{p} - \frac{I\textsubscript{p}}{100} \times 
    ...
    \;\; , \;\;
    \eta\textsubscript{i} \in \; (0,1)
    \label{eq:netrev}
  \end{equation}
  \begin{equation}
    R\textsubscript{r\textsubscript{i}} = \ \mathds{1} \ \textsubscript{Pr\textsubscript{c}}(f(k\textsubscript{i}) \mypm 
...
\sum_{i=1}^{n} R\textsubscript{v\textsubscript{i}}  \\
