...
item and time in e-retail setting. To optimize offer, we first build a generalized non-linear model using 
...
Finally, we optimize offer values using constraint based multi-objective optimization technique.
